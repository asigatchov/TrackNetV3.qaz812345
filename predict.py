...
from utils.general import generate_frames, get_model, write_pred_csv, write_pred_video, to_img_format, to_img
...
if __name__ == '__main__':
    ...
    out_csv_file = os.path.join(args.save_dir, f'{video_name}_ball_predict.csv')
